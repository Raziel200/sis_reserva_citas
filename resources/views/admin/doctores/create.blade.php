...
@section('content')
    <div class="row">
        <h1>Registro de nuevo Profesional</h1>
    </div>
    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form group">
                                    <label for="">Nombres del Profesional</label> <b>*</b>
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    <label for="">Apellidos del Profesional</label> <b>*</b>
                            ...
                            <div class="col-md-3">
                                <div class="form group">
                                    <label for="">Area especializada</label> <b>*</b>
